package com.trueshot.notification.constant;

public class ConsumerConstant {
    public static final String TOPIC_NAME = "trueshot.recent-activities.comment";
    public static final String GROUP_ID = "trueshot.recent-activities.consumer.notification";
